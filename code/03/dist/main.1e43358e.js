...
var patch = (0, _init.init)([_eventlisteners.eventListenersModule, _style.styleModule]);
var vnode; // 初始化 data

var data = [];
data.push(creationData()); // 创建 vnode

function creationDom(data) {
  return (0, _h.h)('div.page-box', [(0, _h.h)('div.page-head', [(0, _h.h)('button.btn.add', {
    on: {
      click: add
    }
  }, '新增'), (0, _h.h)('button.btn.sort', {
    on: {
      click: sort
    }
  }, '排序')]), (0, _h.h)('div.page-body', [(0, _h.h)('ul', data.map(function (item, index) {
    return (0, _h.h)('li.item-box', {
      key: item.id,
      style: {
        opacity: 0,
        ...
        delayed: {
          opacity: 1,
          transform: "translateY(".concat(item.offsetTop, "px)")
        },
        remove: {
          opacity: 0,
          transform: "translateY(".concat(item.offsetTop, "px) translateX(-200px)")
        }
      },
      hook: {
    ...
    }, [(0, _h.h)('span', "\u5E8F\u53F7\uFF1A".concat(index + 1)), (0, _h.h)('span', "\u540D\u5B57\uFF1A".concat(item.name)), (0, _h.h)('span', "\u5E74\u9F84\uFF1A".concat(item.age)), (0, _h.h)('span.del', {
      on: {
        click: [del, item.id]
      }
    }, 'x')]);
...
},{"snabbdom/build/package/init":"node_modules/snabbdom/build/package/init.js","snabbdom/build/package/h":"node_modules/snabbdom/build/package/h.js","snabbdom/build/package/modules/style":"node_modules/snabbdom/build/package/modules/style.js","snabbdom/build/package/modules/eventlisteners":"node_modules/snabbdom/build/package/modules/eventlisteners.js","mockjs":"node_modules/mockjs/dist/mock.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
